    ...
    <div id="top">
      ...
      <div class="row">
        ...
        if (isset($_SESSION['username'])) {
            ...
            $query = "SELECT PID,Title,Author,Quantity,Price FROM cart INNER JOIN products ON cart.Product=products.PID 
                                          ...
                                          <div class="panel-body">
			                                                <img class="image-responsive block-center" src="' . $path . '" style="height :100px;"> <br>
                                                                        ...
                                                                        Code : ' . $row['PID'] . '     <br>        	 
                                                      									...
                                                      									Price : ' . $row['Price'] . ' Tk. <br>
                                                      									Sub Total : ' . $Stotal . ' Tk. <br>
