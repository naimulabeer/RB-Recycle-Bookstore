...
if (!isset($_SESSION['user']))
    header("location: subscription.php?Message=Login To Continue");
?>
        ...
        <div class="container-fluid" id="books">
            <div class="row">
                <div class="col-md-12 text-center" id="header">
                    <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;"> Recycled Books </h2>
                    <p style="color: rgb(255, 127, 80);">Subscribers Only!!!</p>
                </div>
            </div>

            <?php
            include("config.php");
            $query = "SELECT * FROM products WHERE Category='Recycled Books' ORDER BY Price";
