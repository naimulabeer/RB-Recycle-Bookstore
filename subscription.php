...
<head>
    ...
    <style>
        .gradient-custom {
            ...
            background: linear-gradient(to bottom right, #ccc9dc, #1f363d);
        }
...
<body>
    <div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
            ...
            <span style="font-size: 1.5em; color: #ccc9dc;">
    ...
    <section class="vh-100 gradient-custom">
        <div class="container py-2 px-5 h-100">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12 col-lg-7 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-secondary">Subscription Form</h3>
                            <form action="" method="post">
                                ...
                                <a href="recyclebooks.php" class="form-link text-info">Already a member? Join in </a><br><br>

                                <div class="mt-4 pt-2">
                                    <input class="btn btn-success text-white btn-lg" type="submit" name="submit" value="Subscribe" />
                                </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($varpassword != $varcpassword) {
            ...
            $user_check_query = "SELECT * FROM subscriber WHERE email = '$varemail' LIMIT 1";
            ...
            if ($user) {
                ...
                $_SESSION['user'] = $varemail;
                $_SESSION['success'] = "You are now subscribed to recycle bookstore";
                header('location: recyclebooks.php');
            }
            mysqli_close($conn);
        }
    }
